  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
        ...
        {isAuthenticated ? (
          <>
            ...
            <button
              ...
              className="cyber-border bg-purple-600/30 hover:bg-purple-500/40 text-purple-100 px-4 py-2 rounded-lg text-sm transition-all duration-300"
            >
              Log Out
            </button>
          </>
      ...
      <div className="w-full max-w-3xl relative">
        ...
        {!isAuthenticated ? (
          <div className="cyber-border backdrop-blur-xl rounded-2xl p-12 text-center">
            <p className="text-purple-200 mb-6">Please log in to upload and process videos</p>
            <button
              onClick={() => loginWithRedirect()}
              className="cyber-border bg-purple-600/30 hover:bg-purple-500/40 text-purple-100 px-8 py-4 rounded-xl font-medium transition-all duration-300 backdrop-blur-lg hover:scale-105 transform"
            >
              Log In with Auth0
            </button>
          </div>
